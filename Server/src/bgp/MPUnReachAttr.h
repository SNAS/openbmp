...
public:
     ...
     *
     */
    void parseUnReachNlriAttr(int attr_len, u_char *data, bgp_msg::UpdateMsg::parsed_udpate_data &parsed_data);
...
private:
     ...
     * \param [out]  parsed_data    Reference to parsed_udpate_data; will be updated with all parsed data
     */
    void parseAfi(mp_unreach_nlri &nlri, UpdateMsg::parsed_udpate_data &parsed_data);
     ...
     * \param [out]  parsed_data    Reference to parsed_udpate_data; will be updated with all parsed data
     */
    void parseAfiUnicstIPv6(mp_unreach_nlri &nlri, UpdateMsg::parsed_udpate_data &parsed_data);
};
